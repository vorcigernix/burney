        ...
        <>
            <div class="flex flex-col max-w-md gap-2 p-6 rounded-md shadow-md bg-gray-900 text-gray-100">
                <h2 class="flex items-center gap-2 text-xl font-semibold leading-tight tracking-wide">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" class="w-6 h-6 fill-current shrink-0 text-yellow-400">
                ...
                <p class="flex-1 text-gray-400">Mauris et lorem at elit tristique dignissim et ullamcorper elit. In sed feugiat mi. Etiam ut lacinia dui.</p>
                <div class="flex flex-col justify-end gap-3 mt-6 sm:flex-row">
                    <button class="px-6 py-2 rounded-sm">No</button>
                    <button class="px-6 py-2 rounded-sm shadow-sm bg-amber-400 text-gray-900">Yes</button>
                </div>
            </div>
        </>
    );
